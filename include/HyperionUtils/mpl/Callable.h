...
namespace hyperion::utils::mpl {
	...
	/// @brief Type Trait to determine if `T` is a function or function object callable with a
	/// one parameter of the type `Param`
	///
	...
	/// @brief Value of Type Trait `is_callable`. Used to determine if `T` is a function or function
	/// object callable with one parameter of the type `Param`
	template<typename T, typename Param>
	inline static constexpr bool is_callable_with_v = is_callable_with<T, Param>::value;

	/// @brief Type Trait to determine if `T` is a function or function object callable with one
	/// parameter taking the form of each of the types in the `mpl::list`, `List`
	///
	/// @tparam T - The function/function object
	...
	/// @brief Value of Type Trait `is_callable_with_all`. Used to determine if `T` is a function or
	/// function object callable with one parameter taking the form of each of the types in the
	/// `mpl::list`, `List`
	template<typename T, typename List>
